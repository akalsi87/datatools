...
#  define fstatCall fstat
#else
#  define statStruct struct stat64
#  define fstatCall fstat64
#endif

  // file size
  statStruct statInfo;
  if (fstatCall(_file, &statInfo) < 0)
    return false;
...
#if defined(__APPLE__)
#  define mmapCall ::mmap
#else
#  define mmapCall ::mmap64
#endif

  // Linux
  // new mapping
  _mappedView = mmapCall(NULL, mappedBytes, PROT_READ, MAP_SHARED, _file, offset);
